...
public class FuncionIntervalo extends Funcion{
	...
	/*Clase que calcula en el vector de índices los comienzos en los que hay una 
	 * subida o bajada de tamaño ventana en el árbol escogido y menor que un valor dado*/
