...
public class MuestraArbol extends ContinuousFunctionPlotter2{
	...
	public double getY(double arg0) {
		double y;
		arg0=arg0-1; //Es necesario hacer esto porque nuestros árboles empiezan en la medida 1 y no la 0
		int parteEnt = (int) arg0;
		if(arg0<ini || arg0>fin) y=0;
		else if(nombre.equals("Trozo") && arg0==ini){			
			float y1=datos.get(parteEnt-ini+base);
			y=parteEnt;
			...
			if(parteEnt==fin) y2=0;
			else y2=datos.get(parteEnt+1-ini+base);
